  ...
  return (
    <div className="w-24 bg-gradient-to-b from-blue-600 to-purple-600 flex flex-col items-center py-8 gap-8">
      ...
      <nav className="flex flex-col gap-6 flex-1">
        <button className="p-3 hover:bg-white/20 rounded-lg transition" title="Dashboard">
          <Home size={24} className="text-white" />
        </button>
        <button className="p-3 hover:bg-white/20 rounded-lg transition" title="Text Chat">
          <MessageCircle size={24} className="text-white" />
        </button>
        <button className="p-3 hover:bg-white/20 rounded-lg transition" title="Voice Call">
          <Mic2 size={24} className="text-white" />
        </button>
        <button className="p-3 hover:bg-white/20 rounded-lg transition" title="Session History">
